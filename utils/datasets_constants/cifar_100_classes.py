# CIFAR-100 fine-label class names (torchvision label order), spaced for CLIP prompts.
cifar_100_classes = [
...
nr_of_classes = len(cifar_100_classes)

# Images per class in the CIFAR-100 test split (100 classes x 100 = 10000).
cifar_100_elements_per_class = 100
